    ...
    <div className='bg-[#F9F9F9] py-5'>
     <div className='w-full bg-white h-fit lg:mt-[110px] mt-[85px] mb-[10px] py-10 '>
        ...
        <div className='flex flex-col items-center justify-center'>
          <p data-aos="fade-down" className='font-semibold text-[13px] text-[#626262] uppercase font-montserrat'>Activities</p>  
          <p className='font-normal  lg:text-[33px] md:text-[28px] text-[22px] text-[#A3364E] text-center font-alata '>Madhuri Dialysis & Research Center</p>
        ...
        <div className='w-full flex flex-col gap-y-10 items-center justify-center mt-6  font-poppins'>
         ...
         <Swiper
          ...
          >
            <SwiperSlide>           
                <img src="/assets/mslide1.svg"/>           
            </SwiperSlide>

            <SwiperSlide>           
                <img src="/assets/mslide2.svg"/>           
            </SwiperSlide>

            <SwiperSlide>           
                <img src="/assets/mslide3.svg"/>           
            </SwiperSlide>

            <SwiperSlide>           
                <img src="/assets/mslide4.svg"/>           
            </SwiperSlide>
        </Swiper>
...
export default MadhuriDialysis
